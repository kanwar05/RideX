...
const ConfirmedRide = (props) => {
  return (
    <div className="p-4 ">
      <h5
        className="w-full flex   items-center justify-center text-3xl mb-2 "
        onClick={() => {
          props.setConfirmedRidePanel(false);
        }}
      >
        <i className="text-lime-500 ri-arrow-down-wide-line"></i>
      </h5>
      <h2 className="text-2xl text-lime-500 mb-2 font-normal">
        Confirm your Ride
      </h2>

      <div className="flex flex-col items-center  justify-between px-6 py-4 w-full  ">
        ...
        <div className="flex flex-col items-start justify-start w-full mt-7 mb-5">
          <div className="flex gap-5 items-center mb-5 w-full">
            ...
            <div className="w-full border-b border-lime-500/80 text-white/80 p-2">
              <h4 className="text-xl font-medium">{props.pickup}</h4>
            </div>
          </div>
          <div className="flex gap-5 items-center mb-5 w-full">
            <h3 className="text-2xl font-semibold ">
            ...
            <div className="w-full border-b border-lime-500/80 text-white/80 p-2">
              <h4 className="text-xl font-medium">{props.destination}</h4>
            </div>
          </div>
          <div className="flex w-full gap-5 items-center mb-8 ">
            ...
            <div className=" w-full border-b border-lime-500/80 text-white/80  p-2 ">
              ...
              <p className="text-base text-gray-300">Cash Cash</p>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="bg-lime-500 text-black w-3/4 text-xl py-3 px-6 rounded-full  "
        >
          Confirm
        </button>
      </div>
