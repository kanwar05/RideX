...
const RidePopUp = (props) => {
  ...
  return (
    <div className="p-4" >
      <h5
        className="w-full flex  items-center justify-center text-3xl  text-gradient-animated "
        onClick={() => {
      ...
      <h2 className="text-xl mb-2 font-medium text-gradient-animated">
        New Ride Available
      </h2>
      ...
      <PremiumCard className="p-6 space-y-6">
        ...
        <div className="flex flex-col items-start w-full">
          <div className="flex gap-5 items-center mb-4 w-full">
            ...
            <div className="w-full border-b border-white/20 p-2">
              <p className="text-base text-gradient-animated">Pickup Location</p>
          ...
          <div className="flex gap-5 items-center mb-4 w-full">
            ...
            <div className="w-full border-b border-white/20 p-2">
              <p className="text-base text-gradient-animated">Destination</p>
        ...
        <div className="w-full flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="w-1/2 rounded-lg py-3 bg-blur-lg glass-lg text-white font-semibold"
          >
            Ignore
          </button>
        </div>
